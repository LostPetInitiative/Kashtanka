    ...
    return (
        <div className="faq-page">
            ...
            <div className="faq-text">
                <h2>У меня есть сайт (или группа в соц. сети) о пропавших или найденных ивотных. Как добавить эти данные в систему?</h2>
                <h2>Что за карточки?</h2>
                ...
                <p>Мы используем передовые технологи в области искусственного Интеллекта (ИИ) и обработки Больших Данных (Big Data) от ведущих интернет компаний, таких как Google, Facebook.</p>
                <p>Используемые технологии позволяют горизонтально масштабировать вычислительные мощности системы и обрабатывать тысячи новых объявлений в секунду.</p>
                <p>Мы используем:</p>
