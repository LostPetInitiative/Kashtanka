    ...
    return (
        <div>
            ...
            <div className="faq-page">
                ...
                <p className="answer">Напишите на <a href='mailto:contact@kashtanka.pet'>contact@kashtanka.pet</a></p>
                ...
                <p className="answer">Сообщите о проблеме на <a href='https://github.com/LostPetInitiative/Kashtanka/issues'>сайте разработки</a> приложения Каштанка.</p>
